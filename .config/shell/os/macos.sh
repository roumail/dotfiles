...
# # Set Powerlevel9k directory shortening strategy
# # truncate_middle another option
# typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_last
# typeset -g POWERLEVEL9K_DIR_TRUNCATE=3  # Adjust this number as needed
# typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=2  # Adjust to set max visible segments
...
# source ~/.fzf-default-config
# source ~/.fzf-git-config
# source <(fzf --zsh)
# eval "$(rbenv init - zsh)"
